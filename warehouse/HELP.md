...
Kafka - server & and topics launch
https://kafka.apache.org/quickstart

After launching server Kafka, let's create topic:
`bin/kafka-topics.sh --create --partitions 1 --replication-factor 1 --topic warehouse --bootstrap-server localhost:9092`
